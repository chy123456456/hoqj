...
public class DESEncrypt {
    ...
    /*
     * public static void main(String[] args) throws Exception { DESEncrypt des = new
     * DESEncrypt(Constants.USER_REGISTER_ACTIVE_KEY); System.out.println(des.encrypt(strIn)); }
     */
}
